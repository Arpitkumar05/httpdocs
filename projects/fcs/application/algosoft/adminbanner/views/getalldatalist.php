      ...
      <div class="col-sm-9">
        <div id="dataTables-example_filter" class="dataTables_filter">
          ...
          <select size="1" name="search_field" id="search_field" class="form-control input-sm">
            ...
            <option value="title" <?php if($searchfield == 'title')echo 'selected="selected"'; ?>>title</option>
          ...
          <tbody>
            ...
            <tr class="<?php if($i%2 == 0): echo 'gradeA odd'; else: echo 'gradeA even'; endif; ?>" role="row">
              <td class="sorting_1"><?=$i++?></td>
                        <td><?=stripslashes($ALLDATAINFO['page_name'])?></td>
                         <td><?=stripslashes($ALLDATAINFO['title'])?></td>
            <td><img src="<?=stripslashes($ALLDATAINFO['image'])?>" alt="<?=stripslashes($ALLDATAINFO['title'])?>" /></td>
