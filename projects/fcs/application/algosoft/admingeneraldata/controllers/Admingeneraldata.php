...
class Admingeneraldata extends CI_Controller {
    ...
    public
        ...
        $this->layouts->set_title('Manage general data');
    ...
    public
        ...
        if ($this->input->post('SaveChanges')):
            ...
            if ($this->form_validation->run()):
                ...
                if ($this->input->post('CurrentDataID') == ''):
                       $param['type'] = addslashes($this->input->post('type'));
                    $param['status']       = 'Y';
        ...
        $this->layouts->set_title('Add/edit general data');
