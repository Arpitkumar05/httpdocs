    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row show-grid">
                 ...
                 <div class="col-md-1 col-xs-12 col-sm-4"><span><a href="{BASE_URL}siteadmin/homes"><i class="fa fa-dashboard"></i> Home</a></span></div>
                <div class="col-md-3 col-xs-12 col-sm-4"><span><a href="{BASE_URL}adminproducts/managedata">Manage
                            Product</a></span></div>
                 <div class="col-md-3 col-xs-12 col-sm-4"><span><a href="{BASE_URL}{CURRENT_CLASS}/managedata/<?=manoj_encript($_SESSION['product_id'])?>">Manage Product Sections</a></span></div>
                 
                <div class="col-md-3 col-xs-12 col-sm-4">
                    <span><?= $EDITDATA ? 'Edit' : 'Add' ?>
                        Product Section</span></div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    Section <a href="{BASE_URL}{CURRENT_CLASS}/managedata/<?=manoj_encript($_SESSION['product_id'])?>" class="btn btn-default pull-right">Back</a></div>
