      ...
      <div class="col-sm-9">
        <div id="dataTables-example_filter" class="dataTables_filter">
          ...
          <select size="1" name="search_field" id="search_field" class="form-control input-sm">
            ...
            <option value="designation" <?php if($searchfield == 'designation')echo 'selected="selected"'; ?>>Designation</option>
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
          <thead>
            <tr role="row">
                ...
                <th>Name  <span style="color: #41cb52;
    font-size: 13px;">-Designation<span></th>
            <th>Image</th>
           <th>Content</th>
          ...
          <tbody>
           ...
           <td><?=stripslashes($ALLDATAINFO['name'])?> <span style="color: #41cb52;
    font-size: 12px;">-<?=stripslashes($ALLDATAINFO['designation'])?><span> </td>
            <td><img src="<?=stripslashes($ALLDATAINFO['image'])?>" alt="<?=stripslashes($ALLDATAINFO['name'])?>" /></td>
                  <td style="width: 500px; white-space: normal;"><?=stripslashes($ALLDATAINFO['content'])?></td>
