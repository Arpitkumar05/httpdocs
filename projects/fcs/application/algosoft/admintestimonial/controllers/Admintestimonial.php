	...
	************************************************************************/
	public function managedata() 
	{
		...
		$this->front_model->auth_check('view_data');
			...
			$this->layouts->set_title('Manage testimonial');
	...
	************************************************************************/
	...
	{	
		...
		if($this->input->post('SaveChanges')):
			...
			$this->form_validation->set_rules('designation', 'lang:Designatione', 'trim|required');
		...
		$this->layouts->set_title('Add/edit testimonial');
	...
	{ 
		...
		if($file_name): 
			...
			//if($imageInformation[0] >= 1200 && $imageInformation[1] >= 900):
				$this->load->library("upload_crop_img");
				$return_file_name	=	$this->upload_crop_img->_upload_image($file_name,$tmp_name,'testimonial');
...
/* End of file Admindftestimonial.php */
