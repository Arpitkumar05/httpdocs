      ...
      <div class="col-sm-9">
        <div id="dataTables-example_filter" class="dataTables_filter">
          ...
          <select size="1" name="search_field" id="search_field" class="form-control input-sm">
            ...
            <option value="name" <?php if($searchfield == 'name')echo 'selected="selected"'; ?>>Partner</option>
      ...
      <div class="col-sm-12">
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
          ...
          <tbody>
           ...
           <?php if($ALLDATAINFO['show_on'] =='both'):
          echo '<td>Show on Home & Partner page</td>';
           elseif($ALLDATAINFO['show_on'] =='partner'):
          echo '<td>Show on Partner page</td>';
             elseif($ALLDATAINFO['show_on'] =='home'):
          echo '<td>Show on Home page</td>';
             endif;
           ?>
