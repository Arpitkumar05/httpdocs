<form id="Data_Form" name="Data_Form" method="post" action="">
  <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
          ...
          <tbody>
            ...
            <tr class="<?php if($i%2 == 0): echo 'gradeA odd'; else: echo 'gradeA even'; endif; ?>" role="row">
              ...
              <td><?=stripslashes($ALLDATAINFO['mobile'])?></td>
               <td><?php if($ALLDATAINFO['status'] == 'Y'):echo'<span   class="verified"> &#x2714;</span>';else: echo'<span   class="notverified"> &#x2718;</span>';endif;?></td>
              ...
              <?php if($edit_data == 'Y'): ?>
                 ...
                 <?php endif; ?>
                   ...
                   <?php if($view_data == 'Y'): ?>
                  <a class="btn btn-info btn-circle tooltipVal view-details-data" href="javascript:void(0);" data-id="<?=$ALLDATAINFO['id']?>" title="View Customer"><i class="fa  fa-eye"></i></a>
                  <?php endif; ?>
                  </div>
              </td>
              <?php endif; ?>
    ...
    <div class="row mar-top-20">
      ...
      <?php endif; ?>
      <?php if($view_data == 'Y'): ?>
      <a href="javascript:void(0);" title="View data" class="btn btn-info btn-circle"><i class="fa fa-eye"></i></a>&nbsp;->&nbsp;<strong>View data</strong>
      <span   class="verified">  &#x2714</span>&nbsp;->&nbsp;<strong>Verified</strong>
      <span   class="notverified">  &#x2718</span>&nbsp;->&nbsp;<strong>Not Verified</strong>
      <?php endif; ?>
      </span> </div>
    </div>
    <?php endif; ?>
