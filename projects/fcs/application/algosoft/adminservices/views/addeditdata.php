    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <?=$EDITDATA?'Edit':'Add'?>
          Service <a href="{BASE_URL}{CURRENT_CLASS}/managedata" class="btn btn-default pull-right">Back</a></div>
              ...
              <form id="Current_page_form_admin" method="post" role="form" action="">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                      ...
                      <input id="name" class="form-control required " name="name" type="text" value="<?php if(set_value('name')): echo set_value('name'); else: echo stripslashes($EDITDATA['name']);endif; ?>" placeholder=" name">
            ...
            <div class="col-lg-12">
                  <div class="col-lg-10">
                    <div class="form-group">
                      ...
                      <textarea  style="resize:none" name="home_page_content" id="content" class="form-control required" placeholder="home content"><?php if(set_value('home_page_content')): echo set_value('home_page_content'); else: echo stripslashes($EDITDATA['home_page_content']);endif; ?></textarea>
                       
                      <label style="color: #386a94;font-weight: 500 !important;" ><span id="remain">200</span> characters remaining<label>
                      <?php if(form_error('home_page_content')): ?>
                      
                      <label for="home_page_content" generated="true" class="error"><?php echo form_error('home_page_content'); ?></label>
                      <?php endif; ?>
                    </div>
                  </div>
                 </div>
                 <div class="col-lg-12">
                     <div class="col-lg-10">
                    <div class="form-group">
                      <label >Services Page Content<span class="required">*</span></label>
