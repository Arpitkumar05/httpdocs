  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="row show-grid">
        ...
        <div class="col-md-10 col-xs-12 col-sm-4"><span>Manage Services</span></div>
      </div>
      {alert_message}
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">Manage Services
        <?php if($add_data =='Y'): ?>
          <a href="{BASE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default pull-right">Add Service</a>
        <?php endif; ?>
        </div>
