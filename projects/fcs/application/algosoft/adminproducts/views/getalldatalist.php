              ...
              <td><div class="table_action_data">
                  <?php if($edit_data == 'Y'): ?>
                      ...
                      <a class="btn btn-info btn-circle tooltipVal" href="{BASE_URL}{CURRENT_CLASS}/addeditdata/<?=manoj_encript($ALLDATAINFO['id'])?>" title="Edit"><i class="fa fa-pencil"></i></a>
                       ...
                       <a class="btn btn-warning btn-circle tooltipVal" href="{BASE_URL}adminproductsection/Managedata/<?=manoj_encript($ALLDATAINFO['id'])?>" title="View Product Sections"><i class="fa fa-tags"></i></a>
