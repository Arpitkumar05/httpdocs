            ...
            <div class="row show-grid">
                ...
                <div class="col-md-7 col-xs-12 col-sm-4">
                    <span><?= $EDITDATA ? 'Edit' : 'Add' ?>
                        Product Section</span></div><?php else:?>
                <div class="col-md-2 col-xs-12 col-sm-4"><span><a href="{BASE_URL}siteadmin/homes"><i class="fa fa-dashboard"></i> Home</a></span></div>
                <div class="col-md-3 col-xs-12 col-sm-4"><span><a href="{BASE_URL}{CURRENT_CLASS}/managedata">Manage
                            Product</a></span></div>
                <div class="col-md-7 col-xs-12 col-sm-4">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    Product <a href="{BASE_URL}{CURRENT_CLASS}/managedata/<?=manoj_encript($_SESSION['product_id'])?>" class="btn btn-default pull-right">Back</a></div>
                    
                    <?php else: ?> 
                        <div class="panel-heading">
                    <?= $EDITDATA ? 'Edit' : 'Add' ?>
                    
                    Product <a href="{BASE_URL}{CURRENT_CLASS}/managedata" class="btn btn-default pull-right">Back</a></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 three-form">
                            <form id="Current_page_form_admin" method="post" role="form" action="">
                                ...
                                <?php if ($_SESSION['product_id']) : ?>
                                    <input type="hidden" name="product_id" id="CurrentDataID" value="<?= $_SESSION['product_id'] ?>"/>
                                <?php endif; ?>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="name" class="form-control required " name="name" type="text" value="<?php if (set_value('name')): echo set_value('name');
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php else: ?>
                                                    <label>Home Page Image<span class="required">*</span></label>
<?php endif; ?>
...
<?php else: ?>
                                                    <label>Home Page Content<span class="required">*</span></label>
                                                    <textarea  style="resize:none" name="content" id="content" class="form-control required" placeholder="home content"><?php if (set_value('content')): echo set_value('content');
    else: echo stripslashes($EDITDATA['content']);
    endif; ?></textarea>
                                                    <label style="color: #386a94;font-weight: 500 !important;" ><span id="remain">170</span> characters remaining<label>
                                                        </br>
                                                        <?php endif; ?>
...
<?php if (form_error('content')): ?>
                                                        ...
                                                        <!--      <div class="col-lg-12">
                                                                  <div class="col-lg-10">
                                                                 <div class="form-group">
                                                                   <label >Products Page Content<span class="required">*</span></label>
<?php if (set_value('content')): $content = set_value('content');
elseif ($EDITDATA['content']): $content = $EDITDATA['content'];
else: $content = '';
endif; ?>
                                                                   <textarea style="resize:none" name="content" id="Description" class="required" placeholder="content"><?php echo stripslashes($content); ?></textarea>
<?php if (form_error('content')): ?>
