...
class Admindata_model extends CI_Model
{
	...
	************************************************************************/
	...
	{	
		$this->db->select('footer.*,innp.slug as page_slug');
		$this->db->from($tbl_name);
                 $this->db->join("inner_page as innp","footer.link=innp.id","LEFT");
	...
	************************************************************************/
	...
	{
		$this->db->delete('footer', array('id' => $id));
		return true;
	}
