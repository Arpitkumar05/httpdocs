      ...
      <div class="col-sm-9">
        <div id="dataTables-example_filter" class="dataTables_filter">
          ...
          <select size="1" name="search_field" id="search_field" class="form-control input-sm">
            ...
            <option value="footer.section" <?php if($searchfield == 'footer.section')echo 'selected="selected"'; ?>>Section</option>
                   <option value="footer.title" <?php if($searchfield == 'footer.title')echo 'selected="selected"'; ?>>Title</option>
          </select>
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
          ...
          <tbody>
            ...
            <tr class="<?php if($i%2 == 0): echo 'gradeA odd'; else: echo 'gradeA even'; endif; ?>" role="row">
              ...
              <td><?=stripslashes($ALLDATAINFO['section'])?></td>
                <td><?=stripslashes($ALLDATAINFO['title'])?></td>
                <?php  if($ALLDATAINFO['link_type'] == 'manual' ) : ?> 
                  <td><?=stripslashes($ALLDATAINFO['link'])?></td>
           <?php
elseif($ALLDATAINFO['link_type'] == 'page_id') :?>
                   <td>{BASE_URL}<?=stripslashes($ALLDATAINFO['page_slug'])?></td>
