...
class Adminfooter extends CI_Controller {
    ...
    public
        ...
        $this->layouts->set_title('Manage footer');
    ...
    public
        ...
        if ($this->input->post('SaveChanges')):
            $this->form_validation->set_rules('title', 'footer', 'trim|required');
            $this->form_validation->set_rules('section', 'section', 'trim|required');
            $this->form_validation->set_rules('link_type', 'link type', 'trim|required');
            if ($this->input->post('link_type') == 'page_id'):
                $this->form_validation->set_rules('plink', 'page link', 'trim|required');
            elseif ($this->input->post('link_type') == 'manual'):
                $this->form_validation->set_rules('mlink', 'manual link', 'trim|required');
            endif;
            ...
            if ($this->form_validation->run()):
                ...
                $param['section']   = addslashes($this->input->post('section'));
                $param['link_type'] = addslashes($this->input->post('link_type'));
                $param['link']      = addslashes($this->input->post('link'));
                  if ($this->input->post('link_type') == 'page_id'):
           $param['link']      = addslashes($this->input->post('plink'));
            elseif ($this->input->post('link_type') == 'manual'):
                 $param['link']      = addslashes($this->input->post('mlink'));
            endif;
        ...
        $this->layouts->set_title('Add/edit footer');
