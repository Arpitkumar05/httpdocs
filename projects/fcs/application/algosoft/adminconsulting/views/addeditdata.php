    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <?=$EDITDATA?'Edit':'Add'?>
          Consulting <a href="{BASE_URL}{CURRENT_CLASS}/managedata" class="btn btn-default pull-right">Back</a></div>
              ...
              <form id="Current_page_form_admin" method="post" role="form" action="">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                      <label>Consulting Name<span class="required">*</span></label>
