             ...
             <!--    <div class="col-lg-12">
                ...
                <div class="col-lg-8">
                    <div class="form-group">
                     <label >Show Type &nbsp;<span class="required">*</span></label>
                  <?php if(set_value('show_type')): $showtype	=	set_value('show_type'); elseif($EDITDATA->show_type): $showtype	=	stripslashes($EDITDATA->show_type); else: $showtype	= 'left'; endif; ?>
                  <input type="radio" name="show_type" id="show_type1" value="left" class="required" <?php if($showtype == 'left'): echo 'checked="checked"'; endif; ?> />&nbsp; Left &nbsp;&nbsp;
                  <input type="radio" name="show_type" id="show_type2" value="right" class="required" <?php if($showtype == 'right'): echo 'checked="checked"'; endif; ?> />&nbsp; Right
                  <?php if(form_error('show_type')): ?>
                  <label for="show_type" generated="true" class="error"><?php echo form_error('show_type'); ?></label>
                  <?php endif; ?>
                </div>
              </div>
                  </div>
