...
class Adminhomeabout extends CI_Controller {
	...
	************************************************************************/
	public function managedata() 
	{
		...
		$this->front_model->auth_check('view_data');
			...
			$this->layouts->set_title('Manage home about');
	...
	{	
		...
		if($this->input->post('SaveChanges')):
			...
			$this->form_validation->set_rules('content', 'lang:Content', 'trim|required');
                    //    $this->form_validation->set_rules('show_type', 'lang:show type', 'trim|required');
			...
			//	$param['show_type']			=	addslashes($this->input->post('show_type'));
		...
		$this->layouts->set_title('Add/edit home about');
	...
	{ 
		...
		if($file_name): 
			...
			//if($imageInformation[0] >= 1200 && $imageInformation[1] >= 900):
				$this->load->library("upload_crop_img");
				$return_file_name	=	$this->upload_crop_img->_upload_image($file_name,$tmp_name,'home_about');
...
/* End of file Admindfhome about.php */
